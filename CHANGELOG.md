...
- **Per-server permissions** (#43). Settings → Permissions shows every operator and viewer against
  every server. Click a cell to pick what that user may do there: view, power, console, players,
